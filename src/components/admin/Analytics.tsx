                  ...
                  <div className="h-[350px]">
                    <ResponsiveContainer width="100%" height="100%" minWidth={300} minHeight={250}>
                      ...
                      >
                        ...
                        <YAxis 
                          tick={{ fontSize: 12, fill: '#6b7280' }}
                          label={{ value: 'Number of Complaints', angle: -90, position: 'insideLeft', style: { textAnchor: 'middle', fill: '#6b7280' } }}
                        />
                        <Tooltip 
                          contentStyle={{
                            backgroundColor: '#fff',
                          ...
                          formatter={(value: any, name: string) => {
                            if (name === 'complaints') {
                              return [`${value} complaints`, 'Total Complaints'];
                      ...
                      <RechartsPieChart>
                        ...
                        <Tooltip 
                          ...
                          formatter={(value: any, name: string, props: any) => {
                            const percent = props.payload?.resolution_rate;
                            return [
                              `${value} complaints${percent ? ` (${percent}% resolved)` : ''}`,
                              'Complaints'
                            ];
                          }}
                        />
